...
from DeepReg.deepreg.predict import unwrapped_predict
from tqdm import tqdm
from network_utils import write_to_json
import DeepReg.deepreg.model.layer as layer
import h5py
import numpy as np
...
def register(
    ...
    target_image_shape = (256, 128, 21) #TODO: these should not be hardcoded!!!
    target_label_shape = (400, 3)
    ...
    for dataset_dir in dataset_dirs:
        ...
        problems = list(h5py.File(f"{dataset_dir}/fixed_images.h5", "r").keys())
        ...
        for problem in tqdm(problems):
            ...
            #print(ddf)
            print(ddf.shape)
            print(moving_image_roi_tf.shape)
            ...
            #print(f'batched_fixed_image in register:{batched_fixed_image.numpy().squeeze()}')
        ...
        #save registered[dataset_name]
        final_path = os.path.join(output_dir, f'registered_outputs_{dataset_name}.pkl')
        print(final_path)
        with open(final_path, 'wb') as f:
            pickle.dump(registered[dataset_name], f)
